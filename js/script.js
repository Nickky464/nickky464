...
ScrollReveal().reveal('.home-img, .skills-box, .btn, .social-media a, .about-img, .contact form p, .portfolio-box, .contact form, .contact-info-box', { interval: 200, origin: 'bottom' });
